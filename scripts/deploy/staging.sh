#!/bin/bash
# FHub Staging Deployment - Build on Mac, Deploy to LXC 112
...
LXC_ID="112"
LXC_HOST="pve-remote"
IMAGE_NAME="fhub:staging"
IMAGE_TAR="fhub-staging.tar"
DEPLOY_DIR="/opt/fhub"
...
echo ""
echo -e "${BLUE}╔═══════════════════════════════════════════════════════╗${NC}"
echo -e "${BLUE}║         🚀 FHub Staging Deployment 🚀            ║${NC}"
echo -e "${BLUE}╚═══════════════════════════════════════════════════════╝${NC}"
echo ""
...
services:
  fhub:
    ...
    environment:
      ...
      - RUST_LOG=fhub=debug,tower_http=debug
      - TZ=Asia/Bangkok
    healthcheck:
