...
echo -e "${BLUE}╔═══════════════════════════════════════╗${NC}"
echo -e "${BLUE}║     FHub Release Helper          ║${NC}"
echo -e "${BLUE}╚═══════════════════════════════════════╝${NC}"
echo ""
...
echo -e "  - ghcr.io/nas2nd/fhub:v${NEW_VERSION}"
echo -e "  - ghcr.io/nas2nd/fhub:v$(echo $NEW_VERSION | cut -d. -f1-2)"
echo -e "  - ghcr.io/nas2nd/fhub:v$(echo $NEW_VERSION | cut -d. -f1)"
echo -e "  - ghcr.io/nas2nd/fhub:stable"
echo -e "  - ghcr.io/nas2nd/fhub:latest"
echo ""
...
if [[ $REPLY =~ ^[Yy]$ ]]; then
    ...
    echo -e "${BLUE}View release: https://github.com/nas2nd/fhub/releases/tag/v${NEW_VERSION}${NC}"
else
