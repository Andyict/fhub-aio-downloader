...
FHub uses WebSocket for real-time updates between the backend and frontend. This ensures that download progress, state changes, and batch updates are reflected immediately in the UI without requiring manual refresh.
