...
Complete reference for FHub's REST API and WebSocket protocol.
...
For local/offline deployments, FHub should be treated as a trusted local service. If you expose it beyond your LAN, place it behind a reverse proxy or other access control.
