# Contributing to FHub

Thanks for your interest in contributing to FHub! Here's how to get started.
...
2. **Clone** your fork:
   ```bash
   git clone https://github.com/YOUR_USERNAME/fhub.git
   cd fhub
   ```
...
- Use [GitHub Issues](https://github.com/nas2nd/fhub/issues)
