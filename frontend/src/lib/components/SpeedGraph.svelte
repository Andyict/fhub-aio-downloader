<script lang="ts">
  ...
  function createGradient(
    ...
    gradient.addColorStop(0.2, "rgba(255, 138, 31, 0.05)");
    gradient.addColorStop(0.5, "rgba(255, 138, 31, 0.15)");
    gradient.addColorStop(0.8, "rgba(255, 138, 31, 0.3)");
    gradient.addColorStop(1, "rgba(255, 138, 31, 0.5)");
    return gradient;
  }
...
<style>
  ...
  canvas {
    filter: drop-shadow(0 0 10px rgba(255, 138, 31, 0.2));
  }
</style>
