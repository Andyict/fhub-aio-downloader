...
<style>
  .media-card-v3 {
    ...
    -webkit-tap-highlight-color: rgba(255, 138, 31, 0.18);
  ...
  .media-card-v3:hover .card-inner {
    ...
    box-shadow:
      0 20px 50px -10px rgba(255, 138, 31, 0.2),
      0 0 20px rgba(255, 138, 31, 0.1);
  }
  ...
  /* On hover, dots glow orange — sci-fi scanner effect */
  .media-card-v3:hover .card-overlay::before {
    background-image: radial-gradient(
      circle,
      rgba(255, 138, 31, 0.12) 1px,
      transparent 1px
    );
    opacity: 1;
  }
